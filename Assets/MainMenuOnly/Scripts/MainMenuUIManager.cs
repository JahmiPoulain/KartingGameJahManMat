...
public class WheelItem
{
    ...
    [Tooltip("Laisse � 0,0 pour utiliser la taille par d�faut du prefab.")]
...
public class MainMenuUIManager : MonoBehaviour
{
    ...
    [Tooltip("Coche �a si tu trouves que Haut/Bas fait tourner la roue dans le mauvais sens !")]
    ...
    [Header("--- Configuration G�n�rale des Roues ---")]
    ...
    [Tooltip("Cr�e une courbe qui monte � 1.1 puis redescend � 1.0 pour l'effet d'�lan !")]
    ...
    [Header("--- Roue Param�tres (Settings) ---")]
    ...
    [Header("--- Positions Hors-�cran (� la main) ---")]
    [Tooltip("Coordonn�es X/Y quand la roue est masqu�e (ex: X = -1500 pour la mettre � gauche toute)")]
    ...
    private void SelectCurrentWheelOption()
    {
        ...
        else if (currentState == MenuState.PlayGameModes)
        {
            ...
            if (selectedName.Contains("inverted") || selectedName.Contains("toggle"))
            {
                ...
                Debug.Log("Map invers�e est maintenant sur : " + isMapInverted);
